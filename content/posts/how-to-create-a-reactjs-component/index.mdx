...
date: 2019-11-25
description: Components are an essential part of any React application. In this post, we'll be learning how to create a new component.
tags:
  - Tutorial
  - JavaScript
  - ReactJS
...
Although these are just the basics, they will get you pretty close in terms of building things in React. Try messing around with things, passing some props into new components or adding state to a component to present data. These are the foundational building blocks of React. 
