...
Για τους σκοπούς του μαθήματος θα αναπτύξουμε ένα API που θα χρησιμοποιείται για να φτιάχνει μια λίστα από προϊόντα περιποίησης . 
